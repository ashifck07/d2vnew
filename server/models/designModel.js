...
//         luxuryEstimate: null,
//         finalEstimationAmount: null,
//         estimationConfirmed: false,
//       },
//     };

//     const designRef = await db.collection('designs').add(designData);
//     return { id: designRef.id, ...data, createdAt: new Date(), lastUpdated: new Date() };
//   } catch (error) {
//     console.error("Error creating design in Firestore:", error);
...
//       ? db.collection('designs').where('assignedArchitect', '==', architectName)
//       : db.collection('designs');

//     console.log('Query:', query);

//     const designsSnapshot = await query.get();
//     console.log('Designs Snapshot:', designsSnapshot);

//     if (designsSnapshot.empty) {
//       console.log('No designs found');
//     }

//     return designsSnapshot.docs.map((doc) => {
//       const data = doc.data();
//       return {
//         id: doc.id,
...
//     await designRef.update({ ...stateData, lastUpdated: admin.firestore.FieldValue.serverTimestamp() });
//     return { id: designId, ...stateData };
//   } catch (error) {
//     throw new Error(`Failed to update design stage: ${error.message}`);
//   }
// }
...
//       { name: "Premium/Luxury", files: [], enabled: false, updatedAt: null, approved: false },
//       { name: "Final Estimation", amount: null, enabled: false, updatedAt: null, approved: false },
//       { name: "Estimation Confirmed", enabled: false, updatedAt: null, approved: false },
//     ];
...
// designList.sort((a, b) => b.createdAt - a.createdAt);
